...
$nome = $_SESSION['usuarioNome'];
		...
		$sql="SELECT a.*, 
				...
				WHERE to_days(NOW()) - to_days(a.dt_vencimento) <30
							
				and st.id = 2 
				ORDER BY a.dt_vencimento ASC LIMIT $inicio,$quantidade				 
				";
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
			...
			<tbody>
				...
				while ($dados=mysqli_fetch_array($resultado)) {
					...
					<td><?php echo substr ($dados['cnpj_cpf'], 0, 19);?></td>
					...
					<div class="modal fade" id="addEmpModal" tabindex="-1" role="dialog" aria-labelledby="myModaLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="submitadmpend.php" method ="post" enctype="multipart/form-data" >
									<div class="modal-header">
									...
									<div class="modal-body md-n5">
										...
										<div class="form-group px-md-3">
											...
											<textarea type="text" class="form-control " name="txt_area" id="validationTextarea" placeholder="Informações complementares"  required  maxlength="200"></textarea>
							...
							<div class="modal-content ">
								...
								<form  action="updatestatus.php" method ="POST"  >
									...
									<div class="modal-body ">
										...
										<div class="form-group px-md-3" >
											<label><strong style="color:red;">*** Centro de Custo ***</strong></label>
											<select class="custom-select"  name="filial" required>
