...
echo"<br> Nome: ".$nome_colab."<br>";
  ...
  $cnpj_cpf = mysqli_escape_string($conn,$_POST['cnpjl']);
  $cpf1=preg_replace( '#[^0-9]#', '', $cnpj_cpf );
 echo "<br>".$cnpj_cpf1."<br>";
 ...
 echo $fornecedor."<br>";
  ...
  if(isset($_POST['enviar'])) {
    ...
    $query_insert = "INSERT INTO files(date,nome_colab,
                                      id_unidade,fornecedor,
                                      dt_vencimento,arquivo_nome,
                                      arquivo_local,id_userhe,cnpj_cpf)                                                             Values
                                      ('NOW(),'$nome_colab',
                                      '$id_unidade','$fornecedor',
                                      '$dtransf1','$novoNome',
                                      '$uploadFiles','$id','$cnpj_cpf','$valor')";
