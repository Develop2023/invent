...
//$inicio =  ($quantidade*$pagina)-$quantidade;desc LIMIT $inicio,$quantidade
...
emitente_xml,
nr_chave_xml,
DATE_FORMAT(dataemissao_xml,'%d/%m/%Y') as datas,
nr_nfe_xml,
valor_nfe_xml,
cnpj_destinatario,
empresa_xml,
	...
	<nav class="navbar navbar-expand navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse">
			...
			<ul class="navbar-nav ml-auto">
				<!-- ml-auto Move o Menu para Direita-->
			...
			<ul class="list-unstyled">
				...
				<li>
					...
					<ul class="list-unstyled collapse" id="submenu1">
						...
						<li></li> <a href="#"><i class="fas fa-key"></i>&nbsp;Nivel de Acesso</a>
				</li>
			</ul>
			</li>
			...
			<div class="list-group-item">
				...
				<div class="content p-1">
					<div class="d-flex">
						<table class=" table display AllDataTables">
							...
							<tbody>
								...
								?>
								<tr>
									<td><?php echo $dados['cnpj_xml']; ?></td>
								<td><?php echo $dados['emitente_xml']; ?></td> 
										<!--<td><?php //$dados['nr_chave_xml']; ?></td>-->
									<td><?php echo $dados['datas']; ?></td>
									<td><?php echo $dados['nr_nfe_xml']; ?></td>
									<td><?php echo $dados['valor_nfe_xml']; ?></td>
									<td><?php echo $dados['cnpj_destinatario']; ?></td>
									<td><?php echo $dados['empresa_xml'];?></td>
									
									<!-- Botão Visualizar -->
									<td align="center">
										<a href="view.php?id=<?php echo $dados['id_xml']; ?>" target="_blank" class="btn-floating red">
											<i class="fas fa-eye" target="_blank"></i> </a>
									</td>

									<!-- Botão Download -->
									<td align="center">
										<a href="uploadXML/<?php echo $dados['nome_xml'];?>" target="_blank" class="btn-floating red" download>
									...
									<td>
										...
										<div class="  btn-group" role="group">
											...
											<button type="button" class=" btn btn-pill   btn-Warning px-1  viewbtn " data-toggle="modal" data-target="#bd-viewbtn-modal-lg<?php echo $dados['id_xml'];
																																											?>">Visualizar </button>&nbsp;

											<a href="del_xml.php?id=<?php echo $dados['id_xml'];	?>">
								...
								<!-- Visualizar modal -->
								<div class="modal fade " id="bd-viewbtn-modal-lg<?php echo $dados['id_xml'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title " id="exampleModalLabel"><?php echo $dados['emitente_xml'];
																								?></h5>
					...
					<nav aria-label="Page navigation example">
						...
						//echo "<li>";
						// echo "<a class='page-link' href='?pagina=1'><strong>Primeira</strong><span aria-hidden='true'>&laquo;</span></a> ";
						//echo "</li>";
						//echo "<li>";
						//  echo "<a class='page-link' href=\"?pagina=$anterior\"> <strong>Anterior</strong><span aria-hidden='true'>&laquo;</span></a>";
						//echo "</li>";
						?>
						<?php /*
 ...
 echo "<li class='page-item' >"; 
  for($i = $pagina+1; $i < $pagina+$exibir; $i++){
      ...
      */ ?>
						...
						//  <span aria-hidden='true'>&raquo;</span>    <span class='sr-only'>Próximo</span>	</a>  ";
						//echo "</li>";
						//echo "<li>";
						///  echo "  <a class='page-link' href=\"?pagina=$totalPagina\"><strong>Última</strong>//  <span aria-hidden='true'>&raquo;</span> </a>";
						//  echo "</li>";
						//	echo "</ul>";	  
					...
					<div class="modal fade" id="addEmpModal" tabindex="-1" role="dialog" aria-labelledby="myModaLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="submitxml.php" method="post" enctype="multipart/form-data">
									<div class="modal-header">
										<h5 class="modal-title" id="myModaLabel">Inportação Arquivo XML</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								...
								<!-- 	<div class="modal-body md-n5">
										...
										<div class="form-group px-md-4">
											<label><strong>Anexe aqui o arquivo xml</strong></label>
											<div>
												<p><input id="file" type="file" name="arquivos" required></p>

												<div class="modal-footer">
													<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
													<button id="btn" class="btn btn-success">Upload XML</button>
												</div>
